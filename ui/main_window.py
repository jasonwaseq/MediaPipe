...
class MainWindow(QWidget):
    ...
    def __init__(self, explain_results_fn: Callable[[dict], str] | None = None) -> None:
        ...
        export_group_layout.addWidget(self._save_frame_btn)
        export_group_layout.addWidget(self._save_json_btn)
        export_group_layout.addWidget(self._record_btn)
        export_group_layout.addWidget(self._explain_btn)
        export_group_layout.addStretch()
